    ...
    <div class="space-y-6">
        ...
        <section>
            <p class="text-lg font-semibold text-gray-900">
                Hai! Selamat datang di Enerzero <span class="font-mono">[<?php echo e(auth()->user()->name ?? 'username'); ?>]</span>
            </p>
        ...
        <section class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="flex-1 flex gap-4">
                        <div class="w-[150px] h-[150px]">
                            ...
                            <svg viewBox="0 0 36 36" class="w-full h-full">
                                ...
                                <circle r="16" cx="18" cy="18" fill="#34a853" stroke="#2f855a"
                                    stroke-width="5" stroke-dasharray="20 80" stroke-dashoffset="25"
                                    transform="rotate(-90 18 18)" />
                                <circle r="16" cx="18" cy="18" fill="none" stroke="#a0aec0"
                                    stroke-width="5" stroke-dasharray="35 65" stroke-dashoffset="45"
                                    transform="rotate(45 18 18)" />
                                <circle r="16" cx="18" cy="18" fill="none" stroke="#9ae6b4"
                                    stroke-width="5" stroke-dasharray="30 70" stroke-dashoffset="75"
            ...
            <article class="bg-white rounded-lg p-6 shadow-md flex flex-col md:flex-row md:items-center md:gap-6">
                <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=300&q=80"
                    alt="Solar Panels" class="rounded-lg w-full md:w-1/2 object-cover mb-4 md:mb-0" />
                <div class="flex-1">
                    ...
                    <p class="text-gray-800 text-sm my-2">
                        Edukasi energi mencakup berbagai inisiatif yang ditujukan untuk menumbuhkan kesadaran, pemahaman,
                        dan perilaku yang bertanggung jawab terhadapi...
                    </p>
        ...
        <section class="mt-6 grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <article class="md:col-span-3 bg-white rounded-lg p-4 shadow-md overflow-auto max-h-[320px] scrollbar-thin">
                ...
                <div class="space-y-4">
                    <?php $__empty_1 = true; $__currentLoopData = $topForums; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $forum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <a href="<?php echo e(route('forum.show', $forum->id)); ?>">
                            <article class="bg-gray-200 p-3 rounded hover:bg-gray-300 transition duration-200 mb-2">
                                ...
                                <div class="text-xs text-gray-500 mt-1 flex items-center gap-1">
                                    ...
                                    <?php echo e($forum->created_at->diffForHumans()); ?>
            ...
            <aside class="bg-white rounded-lg p-4 shadow-md">
                ...
                <img src="https://cdn.shopify.com/s/files/1/0262/2646/7839/products/lyumo__ez_1_500x.png" alt="Product"
                    class="mb-4 mx-auto max-w-[150px]" />
