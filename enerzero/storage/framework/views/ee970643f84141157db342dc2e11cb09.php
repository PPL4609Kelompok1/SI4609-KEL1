    ...
    <div class="w-90/100">
        ...
        <div class="bg-white w-1/4 p-3 mb-2 rounded-lg">
            <div class="flex item-center gap-4">
                ...
                <input type="text" id="searchInput" placeholder="Type here to search" value="<?php echo e(request('search')); ?>"
        ...
        <?php echo $__env->make('forum.create', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <?php else: ?>
            <?php $__currentLoopData = $forums; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $forum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="<?php echo e($loop->iteration % 2 == 0 ? 'bg-green-100' : 'bg-green-200'); ?> p-4 rounded-lg mb-4 shadow">
                    <h2 class="text-l font-semibold mb-2"><?php echo e($forum->title); ?></h2>
                    
                    <div class="flex items-center mb-4">
                        <img alt="User avatar" class="rounded-full mr-2" src="https://placehold.co/40x40" />
                        <div>
                            <p class="text-gray-900"><?php echo e($forum->username); ?></p>
                            <p class="text-gray-500 text-xs"><?php echo e($forum->created_at->diffForHumans()); ?></p>
                        </div>
                    </div>

                    <p class="text-gray-700 mb-4 text-sm">
                        <?php echo e(Str::limit($forum->description, 200)); ?>

                    </p>

                    <!-- Total Like -->
                    <div class="text-sm text-gray-600 mb-2">
                        ❤️ <?php echo e($forum->likes->count()); ?> likes
                    </div>
