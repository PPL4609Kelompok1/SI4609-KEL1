    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="bg-green-600 px-6 py-4 flex items-center">
                ...
                <h2 class="text-xl font-bold text-white">Edit Perangkat</h2>
            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input type="number" name="wattage" id="wattage" value="{{ old('wattage', $device->wattage) }}" 
                                    class="focus:ring-green-500 focus:border-green-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md" 
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <select name="category" id="category" 
                                    ...
                                    <option value="Elektronik" {{ old('category', $device->category) == 'Elektronik' ? 'selected' : '' }}>Elektronik</option>
                                    <option value="Peralatan Rumah Tangga" {{ old('category', $device->category) == 'Peralatan Rumah Tangga' ? 'selected' : '' }}>Peralatan Rumah Tangga</option>
                                    <option value="Penerangan" {{ old('category', $device->category) == 'Penerangan' ? 'selected' : '' }}>Penerangan</option>
                                    <option value="Lainnya" {{ old('category', $device->category) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                                </select>
                            </div>
                        </div>
