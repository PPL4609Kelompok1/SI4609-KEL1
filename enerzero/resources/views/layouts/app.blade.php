    ...
    <aside class="w-56 bg-white shadow-lg">
        ...
        <nav class="mt-6">
            <ul>
                ...
                <li>
                    <a href="{{ route('education.index') }}" class="flex items-center gap-3 px-6 py-3 {{ request()->routeIs('education.*') ? 'sidebar-active text-green-700 font-semibold' : 'hover:bg-green-200' }}">
