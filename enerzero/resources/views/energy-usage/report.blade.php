...
@php
<<<<<<< HEAD
    $usageArray = $monthlyUsage->toArray();
    $maxUsage = !empty($usageArray) ? max($usageArray) : 1;
@endphp
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg p-6 shadow-md">
            ...
            @else
                <div class="text-center py-4">
                    <p class="text-gray-600">No usage data available. Add your first report to see the breakdown.</p>
                </div>
            @endif
        </div>
        ...
        <div class="bg-white rounded-lg p-6 shadow-md md:col-span-2">
            ...
            @else
                <div class="text-center py-4">
                    <p class="text-gray-600">Add your first energy usage report to get personalized analysis and recommendations.</p>
                </div>
            @endif
        </div>
    </div>
